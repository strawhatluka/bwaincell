  ...
  describe('handleModalSubmit', () => {
    ...
    describe('list_add_item_modal_', () => {
      it('should add item to list', async () => {
        ...
        // Assert
        expect(List.addItem).toHaveBeenCalledWith('test-user', 'test-guild', listName, 'Milk');
        expect(interaction.editReply).toHaveBeenCalledWith({
      ...
      it('should handle special characters in list name', async () => {
        ...
        // Assert
        expect(List.addItem).toHaveBeenCalledWith('test-user', 'test-guild', listName, 'Bread');
      });
