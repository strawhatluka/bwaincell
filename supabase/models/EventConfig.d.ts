...
declare class EventConfig {
     ...
     */
    static upsertConfig(guildId: string, userId: string, location: string, channelId: string, options?: {
        scheduleDay?: number;
        scheduleHour?: number;
     ...
     */
    static updateSchedule(guildId: string, scheduleDay: number, scheduleHour: number, scheduleMinute: number): Promise<EventConfigRow | null>;
    /**
