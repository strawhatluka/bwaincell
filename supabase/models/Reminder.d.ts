...
declare class Reminder {
    static createReminder(guildId: string, channelId: string, message: string, time: string, frequency?: ReminderFrequency, dayOfWeek?: number | null, userId?: string, targetDate?: Date | null, dayOfMonth?: number | null, month?: number | null): Promise<ReminderRow>;
    /**
     ...
     */
    static calculateNextTrigger(time: string, frequency: ReminderFrequency, dayOfWeek: number | null, targetDate?: Date | null, dayOfMonth?: number | null, month?: number | null): Date;
